<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="Task_1.profile" %>
    ...
    <div class="container" style="margin-top: 70px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <asp:Button OnClick="Unnamed_Click" runat="server" ID="btnSave" Text="Update Details" CssClass="btn btn-primary" />
