<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Task_1.register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <asp:Button OnClientClick="return valid()" OnClick="Unnamed_Click" runat="server" ID="btnSave" Text="Register" CssClass="btn btn-primary" />
